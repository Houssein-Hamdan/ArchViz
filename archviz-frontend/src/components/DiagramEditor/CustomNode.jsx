...
// Match architecture component types to icons
const nodeTypeIcons = {
  frontend: Globe,
  backend: Server,
  database: Database,
...
const nodeTypeBadgeColors = {
  ...
  backend:
    'bg-green-100 text-green-900 dark:bg-green-900/60 dark:text-green-300',

  database:
    'bg-orange-100 text-orange-900 dark:bg-orange-900/60 dark:text-orange-300',

  cache:
    'bg-yellow-100 text-yellow-900 dark:bg-yellow-900/60 dark:text-yellow-300',

  queue:
    'bg-purple-100 text-purple-900 dark:bg-purple-900/60 dark:text-purple-300',

  external:
    'bg-red-100 text-red-900 dark:bg-red-900/60 dark:text-red-300',

  storage:
    'bg-indigo-100 text-indigo-900 dark:bg-indigo-900/60 dark:text-indigo-300',

  gateway:
    'bg-pink-100 text-pink-900 dark:bg-pink-900/60 dark:text-pink-300',

  service:
    'bg-cyan-100 text-cyan-900 dark:bg-cyan-900/60 dark:text-cyan-300',
};

export default function CustomNode({ data, selected }) {
  // Fallback icon and styling for unknown node types
  ...
  return (
    <div
      className={`
        ...
        ${
          selected
            ? 'ring-2 ring-offset-2 ring-blue-600 dark:ring-offset-slate-900'
            : ''
        }
      `}
    >
